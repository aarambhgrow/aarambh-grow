            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div
                    className={`w-7 h-7 rounded-full flex items-center justify-center shrink-0 transition-colors duration-200 ${isOpen ? "bg-[#F97316] text-white" : "bg-slate-100 text-slate-500"
                      }`}
                  >
                    <ChevronDown
