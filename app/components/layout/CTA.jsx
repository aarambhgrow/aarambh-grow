        ...
        >
          ...
          >
            <motion.div
              ...
              className="lg:col-span-7 space-y-3 text-center lg:text-left"
            >
              {/* TOP BADGE */}
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed font-normal max-w-xl mx-auto lg:mx-0">
                Partner with our experts to eliminate regulatory roadblocks,
                streamline compliance filings, and build an institutional
